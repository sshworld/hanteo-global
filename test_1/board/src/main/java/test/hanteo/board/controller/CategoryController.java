...
public class CategoryController {
    ...
    @GetMapping
    public List<CategoryResponse> getCategories(CategoryRequest categoryRequest) {
        return categoryService.getAllCategory(categoryRequest).stream().map(CategoryResponse::new).toList();
    }
